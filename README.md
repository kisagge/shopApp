...
주문 조회·**영수증 인쇄**·취소·**일부 상품 취소**·**상품을 골라 반품·다른 옵션으로 교환**·찜·재입고 알림·최근 본 상품·쿠폰·포인트(**소멸 예정일 날짜별**)·문의·알림·회원 탈퇴
...
```
core 918 · web 2,513 · contract 231 · ui 129 · auth 41 · i18n 39 · db 28 · native 22 · mail 7
e2e 793 (Playwright, 68 파일)
```
