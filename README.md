...
**가맹점** — 입점 신청·상품 등록과 검수 요청·재고·주문 처리·**자기 상품 반품 승인과 도착 확인**·문의 답변·**리뷰 읽기**·
...
```
core 881 · web 2,364 · contract 225 · ui 129 · auth 38 · i18n 39 · db 28 · native 22 · mail 7
e2e 782 (Playwright, 62 파일)
```
