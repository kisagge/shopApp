...
**자기 상품 전환율**·**재고 부족 알림**·**주문 CSV 내려받기와 송장 일괄 등록**·정산 확인 (자기 것만 보이도록 조회마다 범위를 건다)
...
```
core 891 · web 2,394 · contract 226 · ui 129 · auth 38 · i18n 39 · db 28 · native 22 · mail 7
e2e 784 (Playwright, 63 파일)
```
