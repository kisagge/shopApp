...
주문 조회·취소·**일부 상품 취소**·반품·찜·재입고 알림·최근 본 상품·쿠폰·포인트·문의·알림·회원 탈퇴
...
회원·권한·**출고 전 일부 취소와 부분 환불**·정산 확정과 지급·리뷰 신고 처리·문의·공지와 FAQ(서식 편집기)·**배송비 정책**·
감사 로그
...
```
core 875 · web 2,319 · contract 225 · ui 128 · auth 38 · i18n 39 · db 28 · native 22 · mail 7
e2e 780 (Playwright, 60 파일)
```
