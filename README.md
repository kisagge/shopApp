...
```
core 736 · web 1,987 · contract 209 · ui 103 · auth 38 · i18n 39 · db 28 · native 22 · mail 7
...
- **여유가 얇은 자리** — 비교함 막대가 떠 있는 상태에서 문의 화면의 긴 입력칸을
  누르면 칸 아래끝(344)과 막대 위끝(349) 사이가 **5px** 다. 가려지지는 않지만,
  칸이 더 커지거나 막대가 두꺼워지면 닿는다.
...
- **앱의 결제 화면 키보드** — 아래에 결제 막대가 붙는 화면은 장바구니에 물건이
  있어야 열려서, 실기기 확인에서 빠졌다. 다른 폼들은 아래 확인란에 적었다.
