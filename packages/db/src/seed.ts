...
const PRODUCTS: SeedProduct[] = [
  ...
  // ── 아우터를 한 쪽보다 많게 ────────────────────────────────────
  //
  // **"더 보기" 를 아무도 못 보고 있었다.** 한 쪽이 24개인데 가장 큰 목록이
  // 13개라, 갓 시드한 DB 에서는 커서 페이지네이션이 화면에 아예 안 나온다.
  // 손으로 눌러 볼 수 없으니 그 자리에 있던 결함(색·사이즈 필터를 안 들고
  // 가던 것)도 여태 안 보였다.
  //
  // 아우터를 26개로 올린다. 한 카테고리만 넘겨도 다음 쪽으로 넘어가는 길이
  // 생기고, 필터를 걸어 둔 채 넘길 때 조건이 따라오는지도 눈으로 볼 수 있다.

  {
    slug: 'melton-single-coat', name: '멜톤 싱글 코트',
    description: '밀도 높은 멜톤 원단이라 바람을 잘 막습니다. 단추를 하나만 둔 싱글 여밈이고, 안주머니를 깊게 내어 지갑이 흔들리지 않습니다.',
    brandSlug: 'studio-noon', categorySlug: 'outer-coat',
    listPrice: 359_000, salePrice: 269_000,
    colors: [{ value: '카멜', hex: '#B08A5A' }, { value: '차콜', hex: '#45423E' }],
    sizes: ['S', 'M', 'L'],
    stock: { S: 6, M: 14, L: 9 },
    rating: 4.7, reviewCount: 432, soldCount: 860,
  },
  {
    slug: 'toggle-hood-coat', name: '토글 후드 코트',
    description: '토글 여밈과 넉넉한 후드. 목도리 없이도 목이 시리지 않게 후드 깊이를 키웠습니다.',
    brandSlug: 'atelier-k', categorySlug: 'outer-coat',
    listPrice: 298_000, salePrice: null,
    colors: [{ value: '네이비', hex: '#2A3242' }, { value: '오트밀', hex: '#E6DFD3' }],
    sizes: ['M', 'L', 'XL'],
    stock: { M: 3, L: 0, XL: 11 },
    rating: 4.5, reviewCount: 188, soldCount: 390,
  },
  {
    slug: 'wool-chester-coat', name: '울 체스터 코트',
    description: '어깨를 세우지 않고 자연스럽게 떨어뜨린 체스터필드. 정장 위에도 걸칠 수 있게 품을 조금 더 뒀습니다.',
    brandSlug: 'plain-label', categorySlug: 'outer-coat',
    listPrice: 268_000, salePrice: 214_000,
    colors: [{ value: '블랙', hex: '#181613' }],
    sizes: ['S', 'M', 'L', 'XL'],
    stock: { S: 12, M: 20, L: 15, XL: 4 },
    rating: 4.6, reviewCount: 267, soldCount: 720,
  },
  {
    slug: 'alpaca-blend-robe-coat', name: '알파카 혼방 로브 코트',
    description: '허리끈으로 여미는 로브형. 알파카를 섞어 같은 두께에서 더 가볍습니다.',
    brandSlug: 'moor', categorySlug: 'outer-coat',
    listPrice: 432_000, salePrice: null,
    colors: [{ value: '베이지', hex: '#D8C9B4' }, { value: '차콜', hex: '#45423E' }],
    sizes: ['S', 'M'],
    stock: { S: 2, M: 5 },
    rating: 4.8, reviewCount: 96, soldCount: 210,
  },
  {
    slug: 'goose-down-long-padding', name: '구스 다운 롱 패딩',
    description: '충전재 90% 구스 다운. 무릎 아래 기장이고, 허리 안쪽에 조임끈을 넣어 바람이 타고 올라오지 않습니다.',
    brandSlug: 'studio-noon', categorySlug: 'outer-padding',
    listPrice: 489_000, salePrice: 391_000,
    colors: [{ value: '블랙', hex: '#181613' }, { value: '카키', hex: '#5A5C4A' }],
    sizes: ['S', 'M', 'L', 'XL'],
    stock: { S: 8, M: 0, L: 6, XL: 13 },
    rating: 4.9, reviewCount: 1043, soldCount: 2480,
  },
  {
    slug: 'lightweight-down-vest', name: '경량 다운 베스트',
    description: '니트 위에 겹쳐 입기 좋은 두께. 접으면 주머니 하나에 들어갑니다.',
    brandSlug: 'moor', categorySlug: 'outer-padding',
    listPrice: 129_000, salePrice: 96_000,
    colors: [{ value: '블랙', hex: '#181613' }, { value: '아이보리', hex: '#F0EBE2' }, { value: '카키', hex: '#5A5C4A' }],
    sizes: ['M', 'L'],
    stock: { M: 24, L: 18 },
    rating: 4.3, reviewCount: 512, soldCount: 1180,
  },
  {
    slug: 'quilted-liner-jacket', name: '퀼팅 라이너 재킷',
    description: '얇은 누빔이라 코트 안에 겹쳐 입어도 당기지 않습니다. 단독으로도 입을 수 있게 목선을 정리했습니다.',
    brandSlug: 'plain-label', categorySlug: 'outer-padding',
    listPrice: 168_000, salePrice: null,
    colors: [{ value: '차콜', hex: '#45423E' }],
    sizes: ['S', 'M', 'L'],
    stock: { S: 0, M: 0, L: 1 },
    rating: 4.4, reviewCount: 133, soldCount: 300,
  },
  {
    slug: 'tweed-collarless-jacket', name: '트위드 노카라 재킷',
    description: '깃을 없애 목이 짧아 보이지 않습니다. 안감을 넣지 않아 봄가을에도 입을 수 있습니다.',
    brandSlug: 'atelier-k', categorySlug: 'outer-jacket',
    listPrice: 224_000, salePrice: 179_000,
    colors: [{ value: '아이보리', hex: '#F0EBE2' }, { value: '네이비', hex: '#2A3242' }],
    sizes: ['S', 'M', 'L'],
    stock: { S: 9, M: 16, L: 0 },
    rating: 4.7, reviewCount: 204, soldCount: 480,
  },
  {
    slug: 'suede-trucker-jacket', name: '스웨이드 트러커 재킷',
    description: '양가죽 스웨이드. 길이를 허리에 맞춰 상의가 들리지 않습니다.',
    brandSlug: 'moor', categorySlug: 'outer-jacket',
    listPrice: 398_000, salePrice: null,
    colors: [{ value: '카멜', hex: '#B08A5A' }],
    sizes: ['M', 'L', 'XL'],
    stock: { M: 4, L: 7, XL: 2 },
    rating: 4.6, reviewCount: 87, soldCount: 190,
  },
  {
    slug: 'cotton-field-jacket', name: '코튼 필드 재킷',
    description: '주머니 넷을 겉으로 낸 필드형. 워싱을 한 번 거쳐 처음부터 뻣뻣하지 않습니다.',
    brandSlug: 'plain-label', categorySlug: 'outer-jacket',
    listPrice: 156_000, salePrice: 124_000,
    colors: [{ value: '카키', hex: '#5A5C4A' }, { value: '베이지', hex: '#D8C9B4' }],
    sizes: ['S', 'M', 'L', 'XL'],
    stock: { S: 14, M: 22, L: 19, XL: 6 },
    rating: 4.2, reviewCount: 341, soldCount: 900,
  },
  {
    slug: 'leather-sleeve-blouson', name: '레더 슬리브 블루종',
    description: '몸판은 울, 소매는 가죽. 밑단과 소매 끝을 립으로 마감해 바람이 들어오지 않습니다.',
    brandSlug: 'studio-noon', categorySlug: 'outer-blouson',
    listPrice: 312_000, salePrice: null,
    colors: [{ value: '네이비', hex: '#2A3242' }, { value: '블랙', hex: '#181613' }],
    sizes: ['M', 'L'],
    stock: { M: 5, L: 3 },
    rating: 4.5, reviewCount: 112, soldCount: 260,
  },
  {
    slug: 'nylon-coach-blouson', name: '나일론 코치 블루종',
    description: '비를 어느 정도 막아 주는 나일론. 스냅 단추라 장갑을 낀 채로도 여밉니다.',
    brandSlug: 'moor', categorySlug: 'outer-blouson',
    listPrice: 118_000, salePrice: 89_000,
    colors: [{ value: '블랙', hex: '#181613' }, { value: '아이보리', hex: '#F0EBE2' }],
    sizes: ['S', 'M', 'L'],
    stock: { S: 20, M: 31, L: 26 },
    rating: 4.1, reviewCount: 428, soldCount: 1320,
  },
  {
    slug: 'corduroy-blouson', name: '코듀로이 블루종',
    description: '골이 가는 코듀로이. 안감을 기모로 대 한겨울에도 이너 하나면 됩니다.',
    brandSlug: 'atelier-k', categorySlug: 'outer-blouson',
    listPrice: 186_000, salePrice: null,
    colors: [{ value: '베이지', hex: '#D8C9B4' }, { value: '차콜', hex: '#45423E' }],
    sizes: ['M', 'L', 'XL'],
    stock: { M: 11, L: 8, XL: 0 },
    rating: 4.4, reviewCount: 156, soldCount: 370,
  },
];
