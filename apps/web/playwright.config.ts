...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch:
        /(customer|review-helpful|notifications|order-idempotency|a11y-account|layout-customer|layout-customer-locales|prefetch-budget|nav-feedback|order-lifecycle|deposit-webhook|checkout-total|payment-callback|stock-race|double-spend|order-search)\.spec\.ts/,
      dependencies: ['setup'],
    },
    {
      name: 'admin',
