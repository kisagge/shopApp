...
export default defineConfig({
  ...
  projects: [
    { name: 'setup', testMatch: /auth\.setup\.ts/ },
    {
      ...
      testMatch:
        /(auth|shopping|a11y|a11y-public|pwa|i18n|recently-viewed|support|recommendations|search-suggest|collections|security-headers|brand-and-filters|compare|layout|image-priority|bundle-budget|web-vitals|sitemap|structured-data)\.spec\.ts/,
    },
    {
      name: 'customer',
